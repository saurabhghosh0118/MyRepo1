...
public class MainController {
	...
	public String addStudents( Model model,HttpSession session, @RequestParam MultipartFile fileUpload,HttpServletRequest request, HttpServletResponse response) 
	{
		...
		try {
			...
			if (fileUpload.getSize() > 0) {
				...
				fileName = "D:/R&D/SavingImageToDatabase/src/main/webapp/img/"
				...
				while ((readBytes = inputStream.read(buffer, 0, 90000)) != -1) {
			...
			// ..........................................
			session.setAttribute("uploadFile", fileUpload.getOriginalFilename());
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	{
	    List<Product> p = service.showStudents();
